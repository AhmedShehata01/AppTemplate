...
namespace Kindergarten.BLL.Models.BranchDTO
{
    public class BranchCreateDTO : BaseEntityDTO
    {
        ...
        //[StringLength(6, MinimumLength = 6, ErrorMessage = "Branch code must be exactly 6 characters.")]
        //[RegularExpression(@"^BR\d{4}$", ErrorMessage = "Branch code must follow the format BR0001.")]
