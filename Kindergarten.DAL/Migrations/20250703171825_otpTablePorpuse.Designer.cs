...
namespace Kindergarten.DAL.Migrations
{
    ...
    [Migration("20250703171825_otpTablePorpuse")]
    partial class otpTablePorpuse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.ActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.DRBRA.RoleSecuredRoute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.DRBRA.SecuredRoute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.DRBRA.SidebarItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.Otp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.ActivityLog", b =>
                {
                    b.HasOne("Kindergarten.DAL.Extend.ApplicationUser", "PerformedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.Branch", b =>
                {
                    b.HasOne("Kindergarten.DAL.Entity.KG", "Kindergarten")
                        .WithMany("Branches")
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.DRBRA.RoleSecuredRoute", b =>
                {
                    b.HasOne("Kindergarten.DAL.Extend.ApplicationRole", "Role")
                        .WithMany("RoleSecuredRoutes")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kindergarten.DAL.Entity.DRBRA.SecuredRoute", "SecuredRoute")
                        .WithMany("RoleSecuredRoutes")
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.DRBRA.SecuredRoute", b =>
                {
                    b.HasOne("Kindergarten.DAL.Extend.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Kindergarten.DAL.Entity.DRBRA.SidebarItem", b =>
                {
                    b.HasOne("Kindergarten.DAL.Entity.DRBRA.SidebarItem", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Kindergarten.DAL.Extend.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
